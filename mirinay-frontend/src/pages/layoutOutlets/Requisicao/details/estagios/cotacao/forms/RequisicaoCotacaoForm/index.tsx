 ...
 * @constructor
 */
export default function RequisicaoCotacaoForm(){
    const viewContext = useView();
    const id = useParams().requisicaoId as unknown as number;
    const endpoint = useEndpoint().requisicao().operacoes(id).cotacao().inserir;
    ...
    const options = [
        {
            value: DestinoEnum.VENDA,
            label: translateDestinoEnum(DestinoEnum.VENDA)
        },
        {
            value: DestinoEnum.ESTOQUE,
            label: translateDestinoEnum(DestinoEnum.ESTOQUE)
        }
    ];

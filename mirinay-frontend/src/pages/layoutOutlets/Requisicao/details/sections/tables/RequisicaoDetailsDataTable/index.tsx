 ...
 */
const RequisicaoDetailsDataTable = memo( function RequisicaoDetailsDataTable() {
    ...
    const contentFunction = useCallback(() => {
        ...
        const destino: DestinoEnum = dataMapped?.destinoEnum ?? "Destino não encontrado.";
...
export default RequisicaoDetailsDataTable;

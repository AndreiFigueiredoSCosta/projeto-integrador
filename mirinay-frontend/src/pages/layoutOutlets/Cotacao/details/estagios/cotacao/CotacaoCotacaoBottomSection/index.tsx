...
import RequisicaoConstrucaoView from "../views/CotacaoCotacaoView";

/**
 * Seção inferior dos detalhes de grupo (Responsável por inicializar propriedades de view)
 * @constructor
 */
export default function CotacaoCotacaoBottomSection(){
    ...
    return (
        <div className={"grupo-bottom-section"}>
            <ViewManager hasSubmitContainer={true} size={"small"} submitBtnText={"cotar"} />

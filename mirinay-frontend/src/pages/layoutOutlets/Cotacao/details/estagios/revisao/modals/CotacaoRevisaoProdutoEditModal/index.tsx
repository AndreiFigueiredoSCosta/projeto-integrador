...
export default function CotacaoRevisaoProdutoEditModal({hide, setHide, data}: GrupoDetailsEditModalProps) {
    ...
    const selectOptions = [
        { label: translateDestinoEnum(DestinoEnum.VENDA), value: DestinoEnum.VENDA },
        { label: translateDestinoEnum(DestinoEnum.ESTOQUE), value: DestinoEnum.ESTOQUE },
    ];
        ...
        >
            ...
            <div style={{
                ...
                <Select
                    ...
                    required={true}
                    disabled={isLoading}
                    value={selectOptions.filter(option => option.value === data?.destino)[0]}
                />
                <Input
                    type={'number'}
                    name={'quantidade'}

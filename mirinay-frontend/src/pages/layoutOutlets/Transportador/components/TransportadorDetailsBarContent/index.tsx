...
export default function TransportadorDetailsBarContent ( { onDeleteClick, onEditClick } : GrupoDetailsBarContentProps ){
    const navigate = useNavigate();

    return (
        <div className={"grupo-details-bar-content"}>
            <div>
                <ReturnButton onClick={() => navigate("/transportador")}> voltar </ReturnButton>
            </div>
            <div>

...
export default function ProdutoDetailBarContent ( { onDeleteClick, onEditClick } : GrupoDetailsBarContentProps ){
    const navigate = useNavigate();

    return (
        <div className={"grupo-details-bar-content"}>
            <div>
                <ReturnButton onClick={() => navigate("/produto")}> voltar </ReturnButton>
            </div>
            <div>

...
export default function GrupoDetailsBarContent ( { onDeleteClick, onEditClick } : GrupoDetailsBarContentProps ){
    const navigate = useNavigate();

    return (
        <div className={"grupo-details-bar-content"}>
            <div>
                <ReturnButton onClick={() => navigate("/grupo")}> voltar </ReturnButton>
            </div>
            <div>
